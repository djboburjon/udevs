    ...
    >
      <div className=" max-w-[1140px] mx-auto ">
        <div className="flex justify-between flex-row-reverse gap-28">
          <div className="w-1/2">
            <img className="mb-8" src="/images/goodzoneLogo.png" alt="" />
            <div className="bg-[#FDCCCC] text-[#F50000] inline-flex items-center gap-2 py-1 px-4 rounded-[100px] text-sm font-medium mb-9">
              <img src="/images/goodzoneIcon.svg" alt="" />
